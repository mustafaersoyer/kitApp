...
// aldığımız işlem değişkenine göre işlemler yapalım.
  if($_method  == "POST") {
       ...
       $bilgiler = $db->query("SELECT paylasimlar.pBaslik,paylasimlar.pAciklama,kitaplar.kitapAdi,kitaplar.kitapResimUrl FROM paylasimlar INNER JOIN kitaplar on paylasimlar.pKitapId=kitaplar.kitapId", PDO::FETCH_ASSOC);
